                        ...
                        <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                           data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <span class="mr-2 d-none d-lg-inline text-gray-600">
                                Hola! ${sessionScope.user.primerNombre}<!--Deleted () to handle Entity-->
                            </span>
                            <img class="img-profile rounded-circle" src=${sessionScope.user.fotoPerfil} style="width:65" alt="profile photo"><!--Deleted () and Base64 to handle Entity-->
